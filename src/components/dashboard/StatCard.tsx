...
export type StatType = "earnings" | "assets" | "members" | "sales" | "network";
...
const stats: Record<StatType, StatConfig> = {
  earnings: {
    title: "Financials - Sales & Earnings",
    icon: Wallet,
    iconBg: "bg-green-100",
...
export default function StatCard({ type, data }: StatCardProps) {
